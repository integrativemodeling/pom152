...
###############################################################################
echo "qsub ./job_clustering_init.sh $PREFILTER $NMODS"
...
###############################################################################
echo "qsub -hold_jid $jid ./job_clustering.sh $PREFILTER $NMODS"
...
###############################################################################
echo "qsub -hold_jid $jid ./job_precision_rmsf.sh $NMODS"
