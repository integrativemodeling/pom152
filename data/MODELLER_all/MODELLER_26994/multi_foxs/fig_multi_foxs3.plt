...
plot f(x) notitle lc rgb '#333333', 'multi_state_model_3_1_1.dat' u 1:($3/$2) notitle w lines lw 2.5 lc rgb '#0000ff'
...
plot 'multi_state_model_3_1_1.dat' u 1:2:4 with yerrorbars notitle lc rgb '#333333' pt 6 ps 0.8, 'multi_state_model_3_1_1.dat' u 1:3 t '3 STATEs {/Symbol c} = x.xxx' w lines lw 2.5 lc rgb '#0000ff'
