...
SAXS_FILE1=SAXS_2012_1214_b2Gp1H.dat
SAXS_FILE2=SAXS_2013_0424_1_b2gp1_closed.dat
SAXS_FILE3=SAXS_2013_0424_5_b2gp1_open.dat
...
for DIR in ../dat2/modeling*.dat; do
    #echo "$DIR"
    echo "$DIR" >> filenames.txt
done

echo "multi_foxs ../$SAXS_FILE filenames.txt -t 0.0 -k $i --max_c1 1.01 --max_c2 0.5 > multi_foxs.log"
multi_foxs ../$SAXS_FILE filenames.txt -t 0.0 -k $i --max_c1 1.01 --max_c2 0.5 > multi_foxs.log
